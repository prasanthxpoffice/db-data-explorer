...
export const i18n = {
  ...
  dict: {
    ...
    ar: {
      app_title: 'مستكشف بيانات الرسم البياني',
      ...
      highlight_hubs: 'تمييز المراكز',
      hubs_deg_ge: '(الدرجة ≥)',
      max_edges_per_node: 'أقصى حواف/عقدة',
      label_threshold: 'حد إظهار الملصقات',
      stop_node_expand: 'إيقاف توسّع العقدة',
      tidy: 'ترتيب',
      ...
      select_views: 'اختر العروض',
      selected_prefix: 'المحدد:',
      alert_pick_entity_value: 'اختر كيانًا ثم أدخل قيمة.',
      alert_select_nodes: 'حدد عقدة/عقدًا في الرسم للإضافة.',
      no_active_columns: 'لا أعمدة مفعّلة',
    },
  },
